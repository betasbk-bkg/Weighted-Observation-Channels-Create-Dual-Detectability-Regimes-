...
*"Weighted observation channels split coordinated attacks into detectability regimes in crowd-sourced continuous control."*
Single author: BongKeun Song (Friedrich-Alexander-Universität Erlangen-Nürnberg).
...
code/
  ...
  variance_channel_verify.py      variance-channel verification (pre-specified predictions PV1–PV3, lightweight)
...
2. **Variance-channel verification (pre-specified predictions PV1–PV3).**
   ```
   cd code
